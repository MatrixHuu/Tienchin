package org.javaboy.tienchin.quartz.controller;
...
import org.javaboy.tienchin.quartz.util.ScheduleUtils;
...
public class SysJobController extends BaseController {
     ...
     * 新增定时任务
     */
    @PreAuthorize("hasPermission('monitor:job:add')")
     ...
     * 修改定时任务
     */
    @PreAuthorize("hasPermission('monitor:job:edit')")
     ...
     * 定时任务状态修改
     */
    @PreAuthorize("hasPermission('monitor:job:changeStatus')")
    @Log(title = "定时任务", businessType = BusinessType.UPDATE)
